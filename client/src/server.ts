...
export const fetchRandom50 = (): Promise<ApiResponse<GifItem[]>> =>
...
export const listAll = (page: number): Promise<ApiResponse<GifItem[]>> =>
  fetch(`${baseUrl}/all`).then(r => r.json());

export const search = (q: string): Promise<ApiResponse<GifItem[]>> =>
